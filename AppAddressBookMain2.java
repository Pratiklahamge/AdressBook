...
public class AppAddressBookMain2 {
	static ArrayList<Contacts> contactList = new ArrayList<>();
	public static void main(String[] args) {
		System.out.println("***********************************************\n          Welcome To Address Book\n***********************************************\n");
		AppAddressBookMain2 appAddressBookMain2= new AppAddressBookMain2();
		int ch = 0;
		while (ch == 0) {
			...
			switch (choice) {
			case 1 :appAddressBookMain2.createContact();
			case 2 : appAddressBookMain2.display();
			case 3 : appAddressBookMain2.edit();
			case 4 : ch = 1;

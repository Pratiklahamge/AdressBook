...
public class AppAddressBookMain1 {
	
	    static ArrayList<Contacts> contactList = new ArrayList<>();

		    public static void main(String[] args) {
		        System.out.println("***********************************************\n          Welcome To Address Book\n***********************************************\n");
		       AppAddressBookMain1 appAddressBookMain1 = new AppAddressBookMain1();
		        int ch = 0;
		        while (ch == 0) {
		    ...
		    private void createContact() {
		        ...
		        Contacts contacts = new Contacts(number, zipcode, state, city, address, lastName, firstName, null);
